...
function addVein(name, worldGenLayer, size, weight, minHeightRange, maxHeightRange, indicatorMaterial, indicatorPlacement, layers) {
  GTCEuServerEvents.oreVeins((event) => {
    event.add("kubejs:" + name, (vein) => {
      ...
      vein.surfaceIndicatorGenerator((i) => i.surfaceRock(indicatorMaterial)
