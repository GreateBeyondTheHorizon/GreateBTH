...
var itemsToReplace = [
    ...
    {
        removedItem: 'ad_astra:desh_engine',
        replacement: 'kubejs:tungsten_steel_engine',
    },

    { removedItem: 'ae2:ender_dust', replacement: 'gtceu:ender_pearl_dust' },

    {
        removedItem: 'aether:ambrosium_shard',
        replacement: 'gtceu:ambrosium_gem',
    },
    ...
    {
        removedItem: 'create:sturdy_sheet',
        replacement: '#forge:plates/obsidian',
    },
    ...
    {
        removedItem: 'create:crushed_raw_copper',
        replacement: 'gtceu:crushed_copper_ore',
    },
    {
        removedItem: 'create:crushed_raw_gold',
        replacement: 'gtceu:crushed_gold_ore',
    },
    {
        removedItem: 'create:crushed_raw_zinc',
        replacement: 'gtceu:crushed_sphalerite_ore',
    },
    {
        removedItem: 'create:crushed_raw_iron',
        replacement: 'gtceu:crushed_iron_ore',
    },
    ...
    {
        removedItem: 'gtceu:hp_steam_macerator',
        replacement: 'greate:andesite_alloy_millstone',
    },
    {
        removedItem: 'gtceu:iv_macerator',
        replacement: 'greate:tungsten_steel_millstone',
        replaceOutput: false,
    },
    {
        removedItem: 'gtceu:iv_bender',
        replacement: 'greate:tungsten_steel_mechanical_press',
        replaceOutput: false,
    },
    {
        removedItem: 'gtceu:iv_mixer',
        replacement: 'greate:tungsten_steel_mechanical_mixer',
        replaceOutput: false,
    },
    {
        removedItem: 'gtceu:iv_cutter',
        replacement: 'greate:tungsten_steel_mechanical_saw',
        replaceOutput: false,
    },
]
