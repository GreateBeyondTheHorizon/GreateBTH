ServerEvents.tags('item', (event) => {
    //#region add item tag
    event.add('ad_astra:aeronos_logs', [
        'ad_astra:aeronos_cap',
        'ad_astra:aeronos_stem',
    ])
    event.add('ad_astra:strophar_logs', [
    ...
    event.add('chipped:stripped_bamboo_log', [
        'minecraft:stripped_bamboo_block',
    ])
    event.add('chipped:stripped_crimson_log', [
    ...
    event.add('dankstorage:blacklisted_storage', [
        '#forge:ores',
        '#forge:raw_materials',
    ])
    ...
    event.add('gbth:certus_quartz_blocks', [
    ...
    event.add('gbth:copper_bloom_inputs', [
    ...
    event.add('gbth:sandpaper_bases', [
        'create:sand_paper',
        'create:red_sand_paper',
    ])
    event.add('gbth:stoves', [
        'farmersdelight:stove',
        'mynethersdelight:nether_bricks_stove',
        '#forge:campfires',
    ])
    event.add('gbth:sleeping_bags', [
        'sleeping_bags:white_sleeping_bag',
        'sleeping_bags:orange_sleeping_bag',
        'sleeping_bags:magenta_sleeping_bag',
        'sleeping_bags:light_blue_sleeping_bag',
        'sleeping_bags:yellow_sleeping_bag',
        'sleeping_bags:lime_sleeping_bag',
        'sleeping_bags:pink_sleeping_bag',
        'sleeping_bags:gray_sleeping_bag',
        'sleeping_bags:light_gray_sleeping_bag',
        'sleeping_bags:cyan_sleeping_bag',
        'sleeping_bags:purple_sleeping_bag',
        'sleeping_bags:blue_sleeping_bag',
        'sleeping_bags:brown_sleeping_bag',
        'sleeping_bags:green_sleeping_bag',
        'sleeping_bags:red_sleeping_bag',
        'sleeping_bags:black_sleeping_bag',
    ])
    event.add('gbth:shelves', [
        'shelfmod:shelf_item_oak',
        'shelfmod:shelf_item_acacia',
        'shelfmod:shelf_item_birch',
        'shelfmod:shelf_item_dark_oak',
        'shelfmod:shelf_item_spruce',
        'shelfmod:shelf_item_jungle',
        'shelfmod:shelf_item_mangrove',
        'shelfmod:shelf_item_bamboo',
        'shelfmod:shelf_item_warped',
        'shelfmod:shelf_item_cherry',
        'shelfmod:shelf_item_crimson',
    ])
    event.add('gbth:floor_shelves', [
        'shelfmod:floor_shelf_item_oak',
        'shelfmod:floor_shelf_item_acacia',
        'shelfmod:floor_shelf_item_birch',
        'shelfmod:floor_shelf_item_dark_oak',
        'shelfmod:floor_shelf_item_spruce',
        'shelfmod:floor_shelf_item_jungle',
        'shelfmod:floor_shelf_item_mangrove',
        'shelfmod:floor_shelf_item_bamboo',
        'shelfmod:floor_shelf_item_warped',
        'shelfmod:floor_shelf_item_cherry',
        'shelfmod:floor_shelf_item_crimson',
    ])
    event.add('gbth:input_buses', [
        'gtceu:ulv_input_bus',
        'gtceu:lv_input_bus',
        'gtceu:mv_input_bus',
        'gtceu:hv_input_bus',
    ...
    event.add('gbth:output_buses', [
        ...
        'gtceu:ev_output_bus',
        'gtceu:iv_output_bus',
        'gtceu:luv_output_bus',
        'gtceu:zpm_output_bus',
        'gtceu:uv_output_bus',
        'gtceu:uhv_output_bus',
    ])
    event.add('gbth:input_hatches', [
    ...
    event.add('gbth:output_hatches', [
        'gtceu:ulv_output_hatch',
        'gtceu:lv_output_hatch',
        'gtceu:mv_output_hatch',
        'gtceu:hv_output_hatch',
        'gtceu:ev_output_hatch',
        'gtceu:iv_output_hatch',
        'gtceu:luv_output_hatch',
        'gtceu:zpm_output_hatch',
        'gtceu:uv_output_hatch',
    ...
    event.add('minecraft:crimson_logs', [
        'minecraft:crimson_stem',
        'minecraft:crimson_hyphae',
        'minecraft:stripped_crimson_stem',
        'minecraft:stripped_crimson_hyphae',
    ])
    event.add('minecraft:warped_logs', [
        'minecraft:warped_stem',
        'minecraft:warped_hyphae',
        'minecraft:stripped_warped_stem',
        'minecraft:stripped_warped_hyphae',
