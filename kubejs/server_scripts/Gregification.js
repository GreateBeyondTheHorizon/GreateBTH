...
ServerEvents.recipes((event) => {
  ...
  Ingredient.of("#gbth:shelves").itemIds.forEach((shelf) => {
    var slab = shelf.replace("shelfmod:shelf_item_", "minecraft:")
      .concat("_slab");
    var planks = shelf.replace("shelfmod:shelf_item_", "minecraft:")
      .concat("_planks");
  ...
  Ingredient.of("#gbth:floor_shelves").itemIds.forEach((shelf) => {
    var slab = shelf.replace("shelfmod:floor_shelf_item_", "minecraft:")
      .concat("_slab");
    var planks = shelf.replace("shelfmod:floor_shelf_item_", "minecraft:")
      .concat("_planks");
