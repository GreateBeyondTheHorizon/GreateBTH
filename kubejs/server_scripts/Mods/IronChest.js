...
var plates = [
	'gtceu:copper_double_plate',
	'gtceu:iron_double_plate',
	'gtceu:gold_double_plate',
	'kubejs:double_diamond_plate',
	'kubejs:double_obsidian_plate',
]
var chests = [
	'minecraft:chest',
...
ServerEvents.recipes(event => {
	...
	event.shaped(
		Item.of('ironchest:crystal_chest'),
		[
			'ABA',
			'BCB',
			'DBE'
