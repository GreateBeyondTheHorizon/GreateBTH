ServerEvents.recipes((event) => {
    ...
    event.remove({
        id: /ae2:tools\/(certus|nether)_quartz_(sword|pickaxe|axe|spade|hoe)/,
    })
    event.remove({
    ...
    event.replaceInput(
        ...
        'minecraft:quartz',
        'gtceu:nether_quartz_plate'
    )

    event.shaped('ae2:energy_acceptor', ['CCC', 'ADA', 'ABA'], {
        A: 'ae2:fluix_block',
        B: 'ae2:energy_cell',
    ...
    event.shaped('ae2:controller', ['CCC', 'ADA', 'ABA'], {
        A: 'ae2:fluix_block',
        B: 'ae2:chest',
        C: 'gtceu:polyvinyl_chloride_foil',
        D: '#gtceu:circuits/hv',
    ...
    event.shaped('ae2:chest', ['EDE', 'AFA', 'CBC'], {
    ...
    event.shaped('ae2:blank_pattern', ['AEA', 'BCB', 'DDD'], {
        A: 'ae2:quartz_glass',
    ...
    event.shaped('ae2:cell_workbench', ['BCB', 'BAB', 'BBB'], {
        A: 'ae2:chest',
    ...
    function toolRecipes(material, quartz) {
        event.shaped(`ae2:${material}_quartz_sword`, [' P ', 'HPF', ' S '], {
        ...
        event.shaped(`ae2:${material}_quartz_pickaxe`, ['PII', 'HSF', ' S '], {
            P: `gtceu:${material}_quartz_plate`,
            I: quartz,
            F: '#forge:tools/files',
            H: '#forge:tools/hammers',
        ...
        event.shaped(`ae2:${material}_quartz_axe`, ['PIF', 'PS ', 'HS '], {
            P: `gtceu:${material}_quartz_plate`,
            H: '#forge:tools/hammers',
            I: quartz,
            F: '#forge:tools/files',
        ...
        event.shaped(`ae2:${material}_quartz_shovel`, ['HPF', ' S ', ' S '], {
            P: `gtceu:${material}_quartz_plate`,
            F: '#forge:tools/files',
            H: '#forge:tools/hammers',
            S: '#forge:rods/wooden',
        ...
        event.shaped(`ae2:${material}_quartz_hoe`, ['PIF', 'HS ', ' S '], {
            P: `gtceu:${material}_quartz_plate`,
            H: '#forge:tools/hammers',
            F: '#forge:tools/files',
            I: quartz,
    ...
    for (const [i, cellSize] of global.AE2.CellSizes.entries()) {
        for (const [material, quality] of Object.entries(
            global.AE2.WaferMaterialQualities
        )) {
            // Wafer
            let engravingOutput =
                'kubejs:' + quality + '_' + cellSize + '_me_storage_wafer'
            ...
            let cuttingIdBase =
                ...
                '_me_storage_base'
            let cuttingOutput =
                storageBaseQualityOutput[quality] +
                'x kubejs:' +
                cellSize +
                '_me_storage_base'
            event.recipes.gtceu
