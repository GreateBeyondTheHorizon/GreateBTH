...
ServerEvents.recipes((event) => {
  ...
  //#region campfire
  event.campfireCooking("gtceu:coke_oven_brick", "gtceu:compressed_coke_clay")
    .cookingTime(300)
    .xp(0.3);
  event.campfireCooking("gtceu:firebrick", "gtceu:compressed_fireclay")
    .cookingTime(300)
    .xp(0.1);
  ...
  event.shaped(Item.of("gtceu:vacuum_tube"), [" B ", "CAC", "DDD"], {
  ...
  event.shaped(Item.of("gtceu:wood_plate"), ["H", "A", "A"], {
    A: "#minecraft:planks",
    H: "#forge:tools/hammers"
  });
  event.shaped(Item.of("gtceu:treated_wood_plate"), ["H", "A", "A"], {
    H: "#forge:tools/hammers",
    A: "gtceu:treated_wood_planks"
  });
  event.shaped(Item.of("gtceu:stone_gear", 1), ["GFG", "FPF", "GFG"], {
    P: "gtceu:wood_gear",
  ...
  event.shaped(
    Item.of("gtceu:flint_knife", "{DisallowContainerItem:0b,GT.Behaviours:{},GT.Tool:{AttackDamage:1.0f,AttackSpeed:3.0f,Damage:0,MaxDamage:63},HideFlags:2}")
  ...
  event.shaped(
    Item.of(
      "gtceu:flint_axe",
      "{DisallowContainerItem:0b,GT.Behaviours:{DisableShields:1b,TreeFelling:0b},GT.Tool:{AttackDamage:4.0f,AttackSpeed:-4.2f,Damage:0,HarvestLevel:2,MaxDamage:63,ToolSpeed:3.5f},HideFlags:2}"
    ),
    ["AC", "B "],
    {
      A: "farmersdelight:rope",
  ...
  event.shaped(Item.of("gtceu:flint_hoe", "{DisallowContainerItem:0b,GT.Behaviours:{},GT.Tool:{AttackDamage:0.0f,AttackSpeed:-1.0f,Damage:0,MaxDamage:63},HideFlags:2}"), ["AC", "B "], {
    A: "farmersdelight:rope",
    B: "minecraft:stick",
    C: "kubejs:flint_hoe_head"
  });

  event.shaped(Item.of("gtceu:empty_wooden_form"), ["FP", "PF"], {
    P: "#minecraft:planks",
    F: "minecraft:flint"
  });

  event.shapeless(Item.of("gtceu:compressed_clay"), ["2x minecraft:clay_ball", "gtceu:brick_wooden_form"])
  ...
  event.shaped(Item.of("gtceu:wooden_tank_valve"), ["SRD", "TPT", "FRF"], {
  ...
  event.shaped(Item.of("gtceu:wooden_multiblock_tank"), ["RPS", "OTD", "FPF"], {
    S: "gtceu:wrought_iron_screw",
    R: "gtceu:wrought_iron_ring",
    D: "#forge:tools/screwdrivers",
    T: "gtceu:treated_wood_planks",
  ...
  event.shaped(Item.of("gtceu:wood_wall", 2), ["STS", "DFH"], {
    S: "gtceu:wrought_iron_screw",
    T: "gtceu:treated_wood_planks",
    D: "#forge:tools/screwdrivers",
    F: "gtceu:treated_wood_frame",
  ...
  event.shaped(Item.of("gtceu:lp_steam_solid_boiler"), ["BBB", "BWB", "RLR"], {
  ...
  event.shaped(Item.of("gtceu:hp_steam_solid_boiler"), ["SSS", "SWS", "BLB"], {
    S: "gtceu:steel_plate",
    W: "#forge:tools/wrenches",
    B: "minecraft:bricks",
  ...
  event.shaped(Item.of("gtceu:hp_steam_liquid_boiler"), ["SSS", "SGS", "SLS"], {
    S: "gtceu:steel_plate",
    G: "#forge:glass",
    L: "gtceu:lp_steam_liquid_boiler"
  });

  event.shaped(Item.of("gtceu:empty_mold"), ["HF", "PP", "PP"], {
    H: "#forge:tools/hammers",
    F: "#forge:tools/files",
    P: "gtceu:steel_plate"
  });

  event.shaped(Item.of("gtceu:hp_steam_solid_boiler"), ["SSS", "SWS", "BCB"], {
    S: "gtceu:steel_plate",
    W: "#forge:tools/wrenches",
    B: "minecraft:bricks",
  ...
  event.shaped("gtceu:flint_hammer", ["CR", "SC"], {
