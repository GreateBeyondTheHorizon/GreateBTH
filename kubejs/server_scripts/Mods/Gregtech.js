...
ServerEvents.recipes((event) => {
    ...
    //#region campfire
    event
        .campfireCooking('gtceu:coke_oven_brick', 'gtceu:compressed_coke_clay')
        .cookingTime(300)
        .xp(0.3)
    event
        .campfireCooking('gtceu:firebrick', 'gtceu:compressed_fireclay')
        .cookingTime(300)
        .xp(0.1)
    ...
    event.shaped(
        Item.of(
            'gtceu:flint_knife',
            '{DisallowContainerItem:0b,GT.Behaviours:{},GT.Tool:{AttackDamage:1.0f,AttackSpeed:3.0f,Damage:0,MaxDamage:63},HideFlags:2}'
    ...
    event.shaped(
        Item.of(
            'gtceu:flint_pickaxe',
            '{DisallowContainerItem:0b,GT.Behaviours:{},GT.Tool:{AttackDamage:2.0f,AttackSpeed:-1.8f,Damage:0,HarvestLevel:1,MaxDamage:63,ToolSpeed:5.5f},HideFlags:2}'
        ),
        ['AC', 'B '],
        {
    ...
    event.shaped(
        Item.of(
            'gtceu:flint_shovel',
            '{DisallowContainerItem:0b,GT.Behaviours:{},GT.Tool:{AttackDamage:2.5f,AttackSpeed:-3.0f,Damage:0,HarvestLevel:2,MaxDamage:63,ToolSpeed:5.5f},HideFlags:2}'
        ),
        ['AC', 'B '],
        {
            A: 'farmersdelight:rope',
    ...
    event.shaped(
        Item.of(
            'gtceu:flint_hoe',
            '{DisallowContainerItem:0b,GT.Behaviours:{},GT.Tool:{AttackDamage:0.0f,AttackSpeed:-1.0f,Damage:0,MaxDamage:63},HideFlags:2}'
        ),
        ['AC', 'B '],
        {
            A: 'farmersdelight:rope',
    ...
    event
        .shapeless(Item.of('gtceu:compressed_clay'), [
    ...
    event.shaped(
        ...
        ['PPP', 'PBP', 'PPP'],
        {
            ...
            B: Item.of(
                ...
                '{Fluid:{Amount:1000,FluidName:"gtceu:creosote"}}'
            ).strongNBT(),
        }
    )
    ...
    event.shaped(
        Item.of(
            'ceramicbucket:ceramic_bucket',
            '{Fluid:{Amount:1000,FluidName:"gtceu:concrete"}}'
        ).strongNBT(),
        ['CBS', 'CWQ', ' L '],
        {
    ...
    // Material parts
    // Wood
    GregUtil.extrudeRingNoIngotMaterial(
        event,
        GTMaterials.Wood,
        'gtceu:wood_plate'
    )
