ServerEvents.recipes((event) => {
  ...
  event.shaped(Item.of("constructionwand:stone_wand"), ["  B", " A ", "A  "], {
    A: "minecraft:stick",
  ...
  event.shaped(Item.of("constructionwand:iron_wand"), [" CB", " AC", "A  "], {
    A: "minecraft:stick",
    B: "gtceu:iron_plate",
    C: "gtceu:iron_screw"
  });
  ...
  event.recipes.createMechanicalCrafting(Item.of("constructionwand:diamond_wand", 1), ["  BB", " CDB", " AC ", "A   "], {
    A: "minecraft:stick",
  ...
  event.recipes.createMechanicalCrafting(Item.of("constructionwand:infinity_wand", 1), ["  CB", "  DC", " A  ", "A   "], {
    A: "minecraft:stick",
