ServerEvents.recipes((event) => {
  ...
  var SophisticatedBackpacks = {
    ...
    toKeyList: function (data) {
      ...
      for (const key in data) {
        transformed[key] = Ingredient.of(data[key])
          .toJson();
      }
      return transformed;
    },
    ...
    makeAdvanced: function (id) {
      event.shaped(Item.of("sophisticatedbackpacks:advanced_" + id, 1), ["ABA", "BCB", "ABA"], {
  ...
  //UPGRADE BASE
  event.shaped(Item.of("sophisticatedbackpacks:upgrade_base", 1), ["ADA", "BCB", "ABA"], {
    A: "#forge:leather",
    B: "#forge:plates/iron",
  ...
  //COMPACTING UPGRADE
  event.shaped(Item.of("sophisticatedbackpacks:compacting_upgrade", 1), ["ADA", "ECE", "ABA"], {
    A: "gtceu:iron_plate",
    B: "#gtceu:circuits/mv",
  ...
  //PICKUP UPGRADE
  event.shaped(Item.of("sophisticatedbackpacks:pickup_upgrade", 1), ["ADA", "ECE", "ABA"], {
    A: "gtceu:iron_plate",
    B: "#gtceu:circuits/mv",
    C: "sophisticatedbackpacks:upgrade_base",
  ...
  //DEPOSIT UPGRADE
  event.shaped(Item.of("sophisticatedbackpacks:deposit_upgrade", 1), ["ADA", "ECE", "ABA"], {
    A: "gtceu:iron_plate",
    B: "#gtceu:circuits/lv",
    C: "sophisticatedbackpacks:upgrade_base",
    D: "minecraft:chest",
  ...
  //RESTOCK UPGRADE
  event.shaped(Item.of("sophisticatedbackpacks:restock_upgrade", 1), ["ADA", "ECE", "ABA"], {
    A: "gtceu:iron_plate",
    B: "#gtceu:circuits/lv",
    C: "sophisticatedbackpacks:upgrade_base",
    D: "minecraft:chest",
  ...
  //VOID UPGRADE
  event.shaped(Item.of("sophisticatedbackpacks:void_upgrade", 1), ["ADA", "ECE", "ABA"], {
    A: "gtceu:iron_plate",
    B: "#gtceu:circuits/mv",
    C: "sophisticatedbackpacks:upgrade_base",
  ...
  //FEEDING UPGRADE
  event.shaped(Item.of("sophisticatedbackpacks:feeding_upgrade", 1), ["A A", "FCE", "ABA"], {
    A: "gtceu:iron_plate",
    B: "#gtceu:circuits/mv",
  ...
  //REFILL UPGRADE
  event.shaped(Item.of("sophisticatedbackpacks:refill_upgrade", 1), ["ADA", "ECE", "ABA"], {
    A: "gtceu:iron_plate",
    B: "#gtceu:circuits/lv",
    C: "sophisticatedbackpacks:upgrade_base",
  ...
  //MAGNET UPGRADE
  event.shaped(Item.of("sophisticatedbackpacks:magnet_upgrade", 1), ["ADA", "ECE", "ABA"], {
    A: "gtceu:iron_plate",
    B: "#gtceu:circuits/mv",
    C: "sophisticatedbackpacks:upgrade_base",
  ...
  //FILTER UPGRADE
  event.shaped(Item.of("sophisticatedbackpacks:filter_upgrade", 1), ["ADA", "ECE", "ABA"], {
    A: "gtceu:iron_plate",
    B: "#gtceu:circuits/mv",
    C: "sophisticatedbackpacks:upgrade_base",
    D: "gtceu:item_filter",
  ...
  //TOOL SWAP UPGRADE
  event.shaped(Item.of("sophisticatedbackpacks:tool_swapper_upgrade", 1), ["ADA", "ECF", "ABA"], {
    A: "gtceu:iron_plate",
    B: "#gtceu:circuits/lv",
    C: "sophisticatedbackpacks:upgrade_base",
    D: "#forge:tools/saws",
  ...
  //JUKEBOX UPGRADE
  event.shaped(Item.of("sophisticatedbackpacks:jukebox_upgrade", 1), ["AJA", "RBR"], {
    A: "#forge:screws/iron",
  ...
  //STONECUTTER UPGRADE
  event.shaped(Item.of("sophisticatedbackpacks:stonecutter_upgrade", 1), ["AJA", "RBR"], {
    A: "#forge:screws/iron",
    B: "sophisticatedbackpacks:upgrade_base",
  ...
  chipped_tables.forEach((table) => {
    event.shaped(Item.of("sophisticatedbackpacks:chipped/" + table + "_upgrade", 1), ["AJA", "RBR"], {
      A: "#forge:screws/iron",
      B: "sophisticatedbackpacks:upgrade_base",
      J: "chipped:" + table,
      R: "#gtceu:circuits/ulv"
