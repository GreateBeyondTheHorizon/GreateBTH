ServerEvents.recipes((event) => {
  ...
  event.recipes.gtceu
    ...
    .itemInputs("gtceu:lv_machine_casing", "2x #gtceu:circuits/hv", "gtceu:mv_electric_motor", "gtceu:small_copper_spring", "gtceu:magnetic_iron_rod", "gtceu:glass_lens")
  ...
  event.recipes.gtceu
    ...
    .itemInputs("gtceu:lv_machine_casing", "2x #gtceu:circuits/hv", "gtceu:mv_electric_motor", "2x gtceu:small_copper_spring", "gtceu:iron_rod")
    .inputFluids("gtceu:polyethylene 72")
  ...
  event.recipes.gtceu
    ...
    .itemInputs("gtceu:lv_machine_casing", "2x #gtceu:circuits/hv", "minecraft:note_block")
    .inputFluids("gtceu:polyethylene 72")
  ...
  event.recipes.gtceu
    ...
    .itemInputs("gtceu:lv_machine_casing", "2x #gtceu:circuits/hv", "create:display_board")
    .inputFluids("gtceu:polyethylene 72")
  ...
  event.recipes.gtceu
    ...
    .itemInputs("gtceu:hv_machine_casing", "2x #gtceu:circuits/ev", "create:display_board")
    .inputFluids("gtceu:polyethylene 72")
  ...
  event.recipes.gtceu
    ...
    .itemInputs("gtceu:mv_machine_casing", "2x gtceu:aluminium_plate", "gtceu:plastic_printed_circuit_board", "#gtceu:circuits/mv", "2x gtceu:polyethylene_rotor")
    .inputFluids("gtceu:polyethylene 72")
  ...
  event.recipes.gtceu
    ...
    .itemInputs("gtceu:hv_machine_casing", "2x gtceu:aluminium_plate", "gtceu:epoxy_printed_circuit_board", "#gtceu:circuits/hv", "2x gtceu:polyethylene_rotor")
    .inputFluids("gtceu:polyethylene 72")
  ...
  event.recipes.gtceu
    ...
    .itemInputs("2x gtceu:aluminium_plate", "gtceu:plastic_printed_circuit_board", "#gtceu:circuits/mv", "gtceu:polyethylene_rotor", "create:display_board")
    .inputFluids("gtceu:polyethylene 72")
  ...
  event.recipes.gtceu
    ...
    .itemInputs("2x gtceu:aluminium_plate", "gtceu:epoxy_printed_circuit_board", "#gtceu:circuits/hv", "gtceu:polyethylene_rotor", "create:display_board")
    .inputFluids("gtceu:polyethylene 72")
  ...
  event.recipes.gtceu
    ...
    .itemInputs("gtceu:lv_machine_casing", "gtceu:plastic_circuit_board", "2x computercraft:cable", "#gtceu:circuits/mv")
    .inputFluids("gtceu:polyethylene 72")
  ...
  event.recipes.gtceu
    ...
    .itemInputs("gtceu:mv_machine_casing", "gtceu:epoxy_circuit_board", "2x computercraft:cable", "#gtceu:circuits/hv", "gtceu:mv_emitter", "gtceu:mv_sensor")
  ...
  event.recipes.gtceu
    ...
    .itemInputs("gtceu:hv_machine_casing", "gtceu:fiber_reinforced_circuit_board", "2x computercraft:cable", "#gtceu:circuits/ev", "gtceu:hv_emitter", "gtceu:hv_sensor")
    .inputFluids("gtceu:polyethylene 72")
  ...
  event.shapeless("computercraft:printed_book", ["minecraft:book", "computercraft:printed_page", "minecraft:string"]);
  ...
  const disk_dye_hex_codes = [1118481, 13388876, 5744206, 8349260, 3368652, 11691749, 5020082, 10066329, 5000268, 15905484, 8375321, 14605932, 10072818, 150404472, 15905331, 15790320];
  for (let i = 0; i < 16; i++) {
    var disk_number = i + 1;
    ...
    event
      .shapeless(
        ...
        ["computercraft:disk", "#forge:dyes/" + global.Minecraft.Dyes[i]]
      )
