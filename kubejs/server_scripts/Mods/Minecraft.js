...
ServerEvents.recipes((event) => {
    ...
    event.recipes.create
        .mixing('minecraft:cake', [
            Fluid.of('minecraft:milk', 3000),
            '2x minecraft:sugar',
    ...
    event.recipes
        .createSequencedAssembly(['minecraft:compass'], emptyCompass, [
            event.recipes.createFilling(emptyCompass, [
                emptyCompass,
                Fluid.of('minecraft:water', 1000),
            ]),
            event.recipes.createDeploying(emptyCompass, [
                emptyCompass,
    ...
    event.shapeless(Item.of('minecraft:bamboo_mosaic_slab', 2), [
    ...
    event
        .shapeless(Item.of('minecraft:clay'), [
