...
ServerEvents.recipes((event) => {
  ...
  event.remove({
    id: /(minecraft|bucketlib|farmersdelight|create):(.*)cake(.*)/,
  ...
  event.campfireCooking("minecraft:brick", "gtceu:compressed_clay")
    .cookingTime(300)
    .xp(0.3);
  event.campfireCooking("minecraft:bread", "gtceu:dough");

  event.recipes.create.mixing("minecraft:cake", [Fluid.of("minecraft:milk", 3000), "2x minecraft:sugar", "farmersdelight:pie_crust", "minecraft:sweet_berries"])
    .heated();
  event.recipes.create.mixing("minecraft:pumpkin_pie", ["minecraft:sugar", "farmersdelight:pie_crust", "minecraft:pumpkin"])
    .heated();

  // Netherite ingot
  event.recipes
    .createMixing("minecraft:netherite_ingot", ["minecraft:netherite_scrap", "minecraft:netherite_scrap", "minecraft:netherite_scrap", "minecraft:netherite_scrap", Fluid.of("gtceu:hssg", 576)])
    .superheated();

  // Chest
  event.shaped(Item.of("minecraft:chest"), ["AAA", "BCB", "AAA"], {
    A: "gtceu:wood_plate",
    B: "gtceu:wood_ring",
    C: "minecraft:flint"
  });
  ...
  // Barrel
  event.shaped("minecraft:barrel", ["PPP", "IRI", "PPP"], {
    P: "#forge:plates/wood",
  ...
  event.shaped(Item.of(emptyCompass, 1), [" B ", "BAB", " B "], {
    A: "gtceu:steel_plate",
    B: "gtceu:tin_ingot"
  });
  event.recipes
  ...
  event.shapeless(Item.of("minecraft:bamboo_mosaic_slab", 2), ["minecraft:bamboo_mosaic", "#forge:tools/saws"]);

  event.recipes.farmersdelight.cutting("minecraft:bamboo_mosaic", "#minecraft:axes", "minecraft:bamboo_mosaic_slab");

  event.shapeless(Item.of("minecraft:clay"), ["3x gtceu:compressed_clay", "kubejs:block_wooden_form"])
  ...
  event.shaped(Item.of("minecraft:crafting_table"), ["AA", "LL"], {
  ...
  event.shaped(Item.of("minecraft:campfire"), ["SS", "LL"], {
  ...
  event.shaped(Item.of("4x minecraft:torch"), ["C", "S"], {
    C: "#minecraft:coals",
    S: "minecraft:stick"
  });
