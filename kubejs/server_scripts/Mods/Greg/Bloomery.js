ServerEvents.recipes((event) => {
  ...
  bloomeryRecipe("gbth:andesite_alloy_bloom", 900, "greate:andesite_alloy_bloom", ["gtceu:wrought_iron_ingot", ["minecraft:andesite", "gtceu:andesite_dust"], "2x #minecraft:coals"]);
