ServerEvents.recipes(event => {
    global.Minecraft.Dyes.forEach(dye => {
        ...
        event.recipes.gtceu.chemical_bath(`dye_sign_to_${dye}`)
            .duration(20)
    ...
    event.recipes.gtceu.chemical_bath(`decolor_hanging_sign`)
        .duration(20)
    ...
    event.recipes.gtceu.chemical_bath(`decolor_sign`)
        .duration(20)
