ServerEvents.recipes((event) => {
  ...
  // Diamond Tier
  event.shaped("sophisticatedstorage:gold_to_diamond_tier_upgrade", ["SDS", "GPG", "SDS"], {
  ...
  // Netherite Tier
  event.shaped("sophisticatedstorage:diamond_to_netherite_tier_upgrade", ["SDS", "GPG", "SDS"], {
