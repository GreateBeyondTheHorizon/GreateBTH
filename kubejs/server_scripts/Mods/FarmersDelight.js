ServerEvents.recipes((event) => {
    ...
    event.shaped('farmersdelight:cutting_board', ['SP', 'SP'], {
        S: '#forge:rods/wood',
        P: '#minecraft:planks',
    })

    event.shaped('farmersdelight:rope', ['S', 'S'], {
    ...
    event.recipes.farmersdelight.cutting(
        'gtceu:rubber_log',
        '#minecraft:axes',
        ['gtceu:stripped_rubber_log', 'farmersdelight:tree_bark']
    )
    event.recipes.farmersdelight.cutting(
        'gtceu:rubber_wood',
        '#minecraft:axes',
        ['gtceu:stripped_rubber_wood', 'farmersdelight:tree_bark']
    )
})
