ServerEvents.recipes(event => {
    ...
    event.remove({id: /(aether|deep_aether):(leather|chainmail|iron|golden|diamond|zanite|skyjade|gravitite)_gloves/})
    event.remove({id: /(aether|deep_aether):(iron|golden|zanite|skyjade|gravitite)_ring/})
  ...
  function armorAndToolRecipe(mod, material) {
    ...
    event.shaped(`${mod}:${material}_chestplate`,
      [
        'PHP',
        'PPP',
        'PPP'
    ...
    event.shaped(`${mod}:${material}_leggings`,
      [
        'PPP',
        'PHP',
        'P P'
    ...
    event.shaped(`${mod}:${material}_boots`,
      [
        'P P',
        'PHP'
      ],
    ...
    event.shaped(`${mod}:${material}_pickaxe`,
      [
        'PII',
        'HSF',
        ' S '
    ...
    event.shaped(`${mod}:${material}_axe`,
      [
        'PIF',
        'PS ',
        'HS '
    ...
    event.shaped(`${mod}:${material}_shovel`,
      [
        'HPF',
        ' S ',
        ' S '
    ...
    event.shaped(`${mod}:${material}_hoe`,
      [
        'PIF',
        'HS ',
        ' S '
