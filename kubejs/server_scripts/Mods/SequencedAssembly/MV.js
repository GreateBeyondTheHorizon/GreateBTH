...
// #endregion
// #region components
	event.recipes.createSequencedAssembly(['gtceu:mv_electric_motor'], 'gtceu:magnetic_steel_rod',
		[
	...
	event.recipes.createSequencedAssembly(['gtceu:mv_robot_arm'], 'gtceu:mv_electric_piston',
		[
	...
	event.recipes.createSequencedAssembly(['gtceu:mv_conveyor_module'], 'gtceu:copper_single_cable',
		[
	...
	event.recipes.createSequencedAssembly(['gtceu:mv_electric_pump'], 'gtceu:steel_normal_fluid_pipe',
		[
	...
	event.recipes.createSequencedAssembly(['gtceu:mv_fluid_regulator'], 'gtceu:mv_electric_piston',
		[
			event.recipes.createDeploying(invMvFluidRegulator, [invMvFluidRegulator, '#gtceu:circuits/mv'])
		]
	).transitionalItem(invMvFluidRegulator).loops(2)

	event.recipes.createSequencedAssembly(['gtceu:mv_sensor'], 'gtceu:electrum_rod',
		[
	...
	event.recipes.createSequencedAssembly(['gtceu:mv_emitter'], 'gtceu:flawless_emerald_gem',
		[
