ServerEvents.recipes((event) => {
  ...
  event.recipes
    .createSequencedAssembly(
      ...
      "gtceu:gold_plate",
      [
        event.recipes.createDeploying("create_connected:incomplete_control_chip", ["create_connected:incomplete_control_chip", "#gtceu:circuits/ulv"]),
        event.recipes.createDeploying("create_connected:incomplete_control_chip", ["create_connected:incomplete_control_chip", "minecraft:redstone"]),
