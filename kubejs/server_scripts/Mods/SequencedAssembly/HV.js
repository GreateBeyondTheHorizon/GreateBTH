...
ServerEvents.recipes((event) => {
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            [
                event.recipes.createDeploying(incHvMotor, [
                    incHvMotor,
                    'gtceu:electrum_double_wire',
                ]),
                event.recipes.createDeploying(incHvMotor, [
                    incHvMotor,
                    'gtceu:electrum_double_wire',
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            'gtceu:hv_electric_motor',
            [
                event.recipes.createDeploying(incHvPiston, [
                    incHvPiston,
                    'gtceu:small_stainless_steel_gear',
                ]),
                event.recipes.createDeploying(incHvPiston, [
                    incHvPiston,
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            'gtceu:hv_electric_piston',
            [
                event.recipes.createDeploying(lncHvRobotArm, [
                    lncHvRobotArm,
                    'gtceu:hv_electric_motor',
                ]),
                event.recipes.createDeploying(lncHvRobotArm, [
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            'gtceu:hv_electric_pump',
            [
                event.recipes.createDeploying(invHvFluidRegulator, [
                    invHvFluidRegulator,
                    '#gtceu:circuits/hv',
                ]),
            ]
    ...
    event.recipes
        .createSequencedAssembly(['gtceu:hv_sensor'], 'gtceu:chromium_rod', [
            event.recipes.createDeploying(invHvSensor, [
                invHvSensor,
                '#gtceu:circuits/hv',
            ]),
            event.recipes.createDeploying(invHvSensor, [
    ...
    event.recipes
        .createSequencedAssembly(['gtceu:hv_emitter'], 'minecraft:ender_eye', [
            event.recipes.createDeploying(incHvEmitter, [
                incHvEmitter,
                '#gtceu:circuits/hv',
            ]),
            event.recipes.createDeploying(incHvEmitter, [
