...
ServerEvents.recipes((event) => {
  ...
  // #region components
  event.recipes
    .createSequencedAssembly(["gtceu:hv_electric_motor"], "gtceu:magnetic_steel_rod", [
  ...
  event.recipes
    .createSequencedAssembly(["gtceu:hv_electric_piston"], "gtceu:hv_electric_motor", [
  ...
  event.recipes
    .createSequencedAssembly(["gtceu:hv_robot_arm"], "gtceu:hv_electric_piston", [
  ...
  event.recipes
    .createSequencedAssembly(["gtceu:hv_conveyor_module"], "gtceu:gold_single_cable", [
      event.recipes.createDeploying(incHvConveyor, [incHvConveyor, ["gtceu:rubber_plate", "gtceu:silicone_rubber_plate", "gtceu:styrene_butadiene_rubber_plate"]]),
      event.recipes.createDeploying(incHvConveyor, [incHvConveyor, ["gtceu:rubber_plate", "gtceu:silicone_rubber_plate", "gtceu:styrene_butadiene_rubber_plate"]]),
      event.recipes.createDeploying(incHvConveyor, [incHvConveyor, ["gtceu:rubber_plate", "gtceu:silicone_rubber_plate", "gtceu:styrene_butadiene_rubber_plate"]]),
  ...
  event.recipes
    .createSequencedAssembly(["gtceu:hv_electric_pump"], "gtceu:stainless_steel_normal_fluid_pipe", [
      ...
      event.recipes.createDeploying(incHvPump, [incHvPump, ["gtceu:rubber_ring", "gtceu:silicone_rubber_ring", "gtceu:styrene_butadiene_rubber_ring"]]),
      event.recipes.createDeploying(incHvPump, [incHvPump, ["gtceu:rubber_ring", "gtceu:silicone_rubber_ring", "gtceu:styrene_butadiene_rubber_ring"]]),
  ...
  event.recipes
    .createSequencedAssembly(["gtceu:hv_fluid_regulator"], "gtceu:hv_electric_pump", [event.recipes.createDeploying(invHvFluidRegulator, [invHvFluidRegulator, "#gtceu:circuits/hv"])])
    .transitionalItem(invHvFluidRegulator)
    .loops(2);

  event.recipes
    .createSequencedAssembly(["gtceu:hv_sensor"], "gtceu:chromium_rod", [
  ...
  event.recipes
    .createSequencedAssembly(["gtceu:hv_emitter"], "minecraft:ender_eye", [
