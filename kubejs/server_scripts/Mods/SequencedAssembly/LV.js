...
ServerEvents.recipes((event) => {
  ...
  event.recipes
    .createSequencedAssembly(["gtceu:lv_electric_piston"], "gtceu:lv_electric_motor", [
  ...
  event.recipes
    .createSequencedAssembly(["gtceu:lv_robot_arm"], "gtceu:lv_electric_piston", [
  ...
  event.recipes
    .createSequencedAssembly(["gtceu:lv_conveyor_module"], "gtceu:tin_single_cable", [
      event.recipes.createDeploying(incLvConveyor, [incLvConveyor, ["gtceu:rubber_plate", "gtceu:silicone_rubber_plate", "gtceu:styrene_butadiene_rubber_plate"]]),
      event.recipes.createDeploying(incLvConveyor, [incLvConveyor, ["gtceu:rubber_plate", "gtceu:silicone_rubber_plate", "gtceu:styrene_butadiene_rubber_plate"]]),
      event.recipes.createDeploying(incLvConveyor, [incLvConveyor, ["gtceu:rubber_plate", "gtceu:silicone_rubber_plate", "gtceu:styrene_butadiene_rubber_plate"]]),
  ...
  event.recipes
    .createSequencedAssembly(["gtceu:lv_electric_pump"], "gtceu:bronze_normal_fluid_pipe", [
      ...
      event.recipes.createDeploying(incLvPump, [incLvPump, ["gtceu:rubber_ring", "gtceu:silicone_rubber_ring", "gtceu:styrene_butadiene_rubber_ring"]]),
      event.recipes.createDeploying(incLvPump, [incLvPump, ["gtceu:rubber_ring", "gtceu:silicone_rubber_ring", "gtceu:styrene_butadiene_rubber_ring"]]),
  ...
  event.recipes
    .createSequencedAssembly(["gtceu:lv_fluid_regulator"], "gtceu:lv_electric_piston", [event.recipes.createDeploying(invLvFluidRegulator, [invLvFluidRegulator, "#gtceu:circuits/lv"])])
    .transitionalItem(invLvFluidRegulator)
    .loops(2);

  event.recipes
    .createSequencedAssembly(["gtceu:lv_sensor"], "#gtceu:circuits/lv", [
  ...
  event.recipes
    .createSequencedAssembly(["gtceu:lv_emitter"], "gtceu:quartzite_gem", [
