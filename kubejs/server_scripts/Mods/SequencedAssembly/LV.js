...
ServerEvents.recipes((event) => {
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            [
                event.recipes.createDeploying(incLvMotor, [
                    incLvMotor,
                ...
                event.recipes.createDeploying(incLvMotor, [
                    incLvMotor,
                    ['gtceu:iron_rod', 'gtceu:steel_rod'],
                ]),
                event.recipes.createDeploying(incLvMotor, [
                    incLvMotor,
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            'gtceu:lv_electric_motor',
            [
                event.recipes.createDeploying(incLvPiston, [
                    incLvPiston,
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            'gtceu:lv_electric_piston',
            [
                event.recipes.createDeploying(lncLvRobotArm, [
                    lncLvRobotArm,
                    'gtceu:lv_electric_motor',
                ]),
                event.recipes.createDeploying(lncLvRobotArm, [
    ...
    event.recipes
        .createSequencedAssembly(
            ...
            'gtceu:lv_electric_piston',
            [
                event.recipes.createDeploying(invLvFluidRegulator, [
                    invLvFluidRegulator,
                    '#gtceu:circuits/lv',
                ]),
            ]
    ...
    event.recipes
        .createSequencedAssembly(['gtceu:lv_sensor'], '#gtceu:circuits/lv', [
            event.recipes.createDeploying(invLvSensor, [
                invLvSensor,
    ...
    event.recipes
        .createSequencedAssembly(['gtceu:lv_emitter'], 'gtceu:quartzite_gem', [
            event.recipes.createDeploying(incLvEmitter, [
                incLvEmitter,
                '#gtceu:circuits/lv',
            ]),
            event.recipes.createDeploying(incLvEmitter, [
