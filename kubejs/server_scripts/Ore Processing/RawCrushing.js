ServerEvents.recipes(event => {
    ...
    for(j; j < gregMaterial.length; j++){
        event.recipes.create.crushing([`gtceu:${gregMaterial[j]}_crushed_ore`,Item.of(`gtceu:${gregMaterial[j]}_crushed_ore`).withChance(0.5), Item.of(`gtceu:${gregMaterial[j]}_crushed_ore`).withChance(0.25),Item.of(`gtceu:${gregMaterial[j]}_impure_dust`).withChance(0.2),Item.of(`gtceu:${extraMaterial[j]}_dust`).withChance(0.2)],  `gtceu:raw_${gregMaterial[j]}`)
