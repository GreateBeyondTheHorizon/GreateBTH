//priority: 1
const $BloomProperty = Java.loadClass(
...
GTCEuStartupEvents.registry('gtceu:material', (event) => {
    ...
    GTMaterials.Iron.setProperty(
        GBTHCorePropertyKeys.BLOOM,
        new $BloomProperty()
    )

    // Add flint hammer for hammering blooms
    GTMaterials.Flint.getProperty(PropertyKey.TOOL).addTypes(
...
GTCEuStartupEvents.materialModification((event) => {
    ...
    ](GTMaterials.CertusQuartz, () => Item.getItem('ae2:quartz_block'))
    TagPrefix.gem[
        'setIgnored(com.gregtechceu.gtceu.api.data.chemical.material.Material,java.util.function.Supplier[])'
    ](GTMaterials.CertusQuartz, () => Item.getItem('ae2:certus_quartz_crystal'))
    TagPrefix.dust[
        'setIgnored(com.gregtechceu.gtceu.api.data.chemical.material.Material,java.util.function.Supplier[])'
    ](GTMaterials.CertusQuartz, () => Item.getItem('ae2:certus_quartz_dust'))

    TagPrefix.dust[
        'setIgnored(com.gregtechceu.gtceu.api.data.chemical.material.Material,java.util.function.Supplier[])'
    ](GTMaterials.Netherrack, () => Item.getItem('create:cinder_flour'))
    TagPrefix.dust[
        'setIgnored(com.gregtechceu.gtceu.api.data.chemical.material.Material,java.util.function.Supplier[])'
    ](GTMaterials.Obsidian, () => Item.getItem('create:powdered_obsidian'))
})
