StartupEvents.registry("item", (event) => {
  ...
  event.create("andesite_alloy_sand_paper", "create:sandpaper")
    .maxDamage(8)
    .displayName("Andesite Alloy Sand Paper");
  event.create("steel_sand_paper", "create:sandpaper")
    .maxDamage(32)
    .displayName("Steel Sand Paper");
  event.create("aluminium_sand_paper", "create:sandpaper")
    .maxDamage(128)
    .displayName("Aluminium Sand Paper");
  event.create("stainless_steel_sand_paper", "create:sandpaper")
    .maxDamage(512)
    .displayName("Stainless Steel Sand Paper");
  event.create("titanium_sand_paper", "create:sandpaper")
    .maxDamage(2048)
    .displayName("Titanium Sand Paper");
  event.create("tungsten_steel_sand_paper", "create:sandpaper")
    .maxDamage(8192)
    .displayName("Tungsten Steel Sand Paper");
  event.create("rhodium_plated_palladium_sand_paper", "create:sandpaper")
    .maxDamage(32768)
    .displayName("Rhodium Plated Palladium Sand Paper");
  event.create("naquadah_alloy_sand_paper", "create:sandpaper")
    .maxDamage(131072)
    .displayName("Naquadah Alloy Sand Paper");
  event.create("darmstadtium_sand_paper", "create:sandpaper")
    .maxDamage(524288)
    .displayName("Darmstadtium Sand Paper");
  event.create("neutronium_sand_paper", "create:sandpaper")
    .maxDamage(2097152)
  ...
  event.create("incomplete_storage_cell", "create:sequenced_assembly")
    .displayName("Incomplete Storage Cell");
  event.create("incomplete_storage_component", "create:sequenced_assembly")
  ...
  event.create("tungsten_steel_engine")
    .displayName("Tungstensteel Engine");
  event.create("tungsten_steel_fin")
    .displayName("Tungstensteel Rocket Fin");
  event.create("tungsten_steel_cone")
    .displayName("Tungstensteel Rocket Nose Cone");

  // HSS-E
  event.create("hsse_engine")
    .displayName("HSS-E Engine");
  event.create("hsse_fin")
    .displayName("HSS-E Rocket Fin");
  event.create("hsse_cone")
    .displayName("HSS-E Rocket Nose Cone");

  // Trinium
  event.create("trinium_engine");
  event.create("trinium_fin")
    .displayName("Trinium Rocket Fin");
  event.create("trinium_cone")
    .displayName("Trinium Rocket Nose Cone");

  // misc
  event.create("unf_turtle_helmet")
    .displayName("Turtle Helmet Shell");
  event.create("infinity_me_storage_wafer")
    .displayName("Infinity ME Storage Component");

  //compass
  event.create("empty_compass")
    .displayName("Empty Compass");

  //befood
  event.create("advanced_honey_treat")
    .displayName("Advanced Honey Treat");
  event.create("titanium_bee_food")
    .displayName("Titanium Bee Food");
  ...
  event.create("block_wooden_form")
    .unstackable()
    .displayName("Block Wooden Form");
  event.create("nugget_wooden_form")
    .unstackable()
  ...
  event.create("flint_pickaxe_head")
  ...
  event.create("flint_sword_head")
    .displayName("Flint Sword Head");
  event.create("flint_hoe_head")
    .displayName("Flint Hoe Head");

  event.create("empty_glue_tube")
    .displayName("Empty Glue Tube");
});
