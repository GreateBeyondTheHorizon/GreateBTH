StartupEvents.registry("item", (event) => {
  ...
  event
    ...
    .tooltip(Text.gray("The original tag was removed in 'startup_scripts/ItemRemoval.js'. Consider removing this recipe or replacing this placeholder with something else."))
  ...
  event
    ...
    .tooltip(Text.gray("The original item was removed in 'startup_scripts/ItemRemoval.js'. Consider removing this recipe or replacing this placeholder with something else."))
    .texture("minecraft:item/barrier");
});
...
//Farmers Delight
removeNamespaceItems("farmersdelight", ["flint_knife", "iron_knife", "diamond_knife", "netherite_knife", "golden_knife", "wheat_dough"]);

//Oreberries
removeNamespaceItems("oreberriesreplanted", ["copper_nugget", /.*_vat/, /uranium_.*/, /osmium_.*/, /.*_bucket/]);

//Aquaculture
removeNamespaceItems("aquaculture", ["wooden_fillet_knife", "stone_fillet_knife", "iron_fillet_knife", "gold_fillet_knife", "diamond_fillet_knife", "neptunium_fillet_knife"]);

removeNamespaceItems("ae2", ["vibration_chamber", "ender_dust", "inscriber"]);

removeNamespaceItems("expatternprovider", ["ex_inscriber", "circuit_cutter", "silicon_block"]);

removeNamespaceItems("gtceu", ["lp_steam_solar_boiler", "hp_steam_solar_boiler", /.*macerator$/, /.*bender$/, /.*mixer$/, /.*[^large]_cutter$/]);

removeNamespaceItems("dankstorage", ["red_print", "1_to_2", "2_to_3", "3_to_4", "4_to_5", "5_to_6", "6_to_7"]);

removeNamespaceItems("aether", ["zanite_block", "zanite_gemstone", "enchanted_gravitite", "ambrosium_block", "ambrosium_shard"]);

removeNamespaceItems("deep_aether", ["skyjade", "skyjade_block"]);

removeNamespaceItems("productivebees", ["bottler", "milk_bottle"]);

removeNamespaceItems("projectred_core", ["red_iron_comp", "red_ingot", "electrotine_dust", "electrotine_generator", "ruby", "sapphire", "peridot"]);

removeNamespaceItems("cb_microblock", ["stone_rod"]);
...
removeNamespaceItems("ends_delight", ["dragon_tooth_knife", "dragon_egg_shell_knife", "purpur_knife", "end_stone_knife"]);
