ItemEvents.tooltip(event => {
	...
	event.add(['tconstruct:fantastic_foundry', 'tconstruct:scorched_drain', 'tconstruct:scorched_duct', 'tconstruct:scorched_chute', 'tconstruct:scorched_fuel_tank', 
		'tconstruct:scorched_fuel_gauge', 'tconstruct:scorched_table', 'tconstruct:scorched_basin', 'tconstruct:scorched_bricks', 
		'tconstruct:chiseled_scorched_bricks', 'tconstruct:scorched_stone', 'tconstruct:polished_scorched_stone', 'tconstruct:scorched_road', 'tconstruct:scorched_ladder',
		'tconstruct:scorched_glass', 'tconstruct:scorched_tinted_glass', 'tconstruct:scorched_soul_glass'],
