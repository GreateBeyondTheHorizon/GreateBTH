...
JEIEvents.hideItems((event) => {
  ...
  event.hide(Item.of("ad_astra:tier_4_rocket", '{BotariumData:{StoredFluids:[{Amount:3000L,Fluid:"ad_astra:fuel"}]}}'));
});
...
JEIAddedEvents.registerRecipes((event) => {
  event.custom("kubejs:create_info")
    .add({
  ...
  event.custom("kubejs:create_info")
    .add({
      input: "create:chromatic_compound",
      catalyst: Item.of("minecraft:end_portal_frame")
        .setHoverName("Drop into the Void in the End."),
